    ...
    <div class="portal-screen">
      ...
      <div class="portal-header">
        <div class="portal-logo-wrap">
          ...
          <div>
            <div class="portal-logo-title">MediCore HMS</div>
  ...
  showPortalLogin(portalId) {
    ...
    <div class="portal-login-screen">
      ...
      <div class="portal-login-card">
        ...
        <form id="login-form" onsubmit="App.handleLogin(event, '${portalId}')">
          <div class="form-group">
            ...
            <div class="input-icon-wrap">
              ...
              <input class="form-input input-with-icon" type="text" id="login-username" placeholder="Enter username" required />
            </div>
          </div>
          ...
          <div class="form-group mt-3">
            ...
            <div class="input-icon-wrap">
              ...
              <input class="form-input input-with-icon" type="password" id="login-password" placeholder="Enter password" required />
            </div>
          </div>
        ...
        <div class="login-hints mt-4">
          <div class="hint-label">${portal.name} Demo Credentials</div>
          ${this.renderPortalCredentials(portalId)}
        </div>
      </div>
    </div>`;
  },

  renderPortalCredentials(portalId) {
    if (portalId === 'admin') {
      return `<div class="hint-row"><span class="hint-role">Administrator</span><span class="hint-cred">admin / Admin@123</span></div>`;
    }
    if (portalId === 'clinical') {
      return `
      <div class="hint-row"><span class="hint-role">Doctor</span><span class="hint-cred">dr.perera / Doctor@123</span></div>
      <div class="hint-row"><span class="hint-role">Nurse</span><span class="hint-cred">nurse1 / Nurse@123</span></div>`;
    }
    if (portalId === 'patient') {
      return `<div class="hint-row"><span class="hint-role">Patient</span><span class="hint-cred">patient1 / Patient@123</span></div>`;
    }
    return `
    <div class="hint-row"><span class="hint-role">Receptionist</span><span class="hint-cred">receptionist1 / Recept@123</span></div>
    <div class="hint-row"><span class="hint-role">Lab Staff</span><span class="hint-cred">lab1 / Lab@123</span></div>
    <div class="hint-row"><span class="hint-role">Pharmacist</span><span class="hint-cred">pharmacist1 / Pharma@123</span></div>
    <div class="hint-row"><span class="hint-role">Accountant</span><span class="hint-cred">accountant1 / Acct@123</span></div>`;
  },
    ...
    <div class="app">
      ...
      <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-footer">
          <div class="user-info">
            <div class="user-avatar" style="background:${portal.gradient}">${(this.user.full_name||'U')[0].toUpperCase()}</div>
        ...
        <header class="topbar">
          ...
          <div class="topbar-right">
            ...
            <div class="topbar-user" onclick="App.navigate('profile')">
              <div class="topbar-avatar" style="background:${portal.gradient}">${(this.user.full_name||'U')[0].toUpperCase()}</div>
